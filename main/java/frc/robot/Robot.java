...
public class Robot extends TimedRobot {
  ...
  WPI_TalonSRX intakeLeft = new WPI_TalonSRX(1);
  WPI_TalonSRX intakeRight = new WPI_TalonSRX(1);
  WPI_TalonSRX intakeBelt = new WPI_TalonSRX(1);
  ...
  public void autonomousPeriodic() {
    ...
    switch(m_autoSelected){
      ...
      case twoBalls:
        ...
        if(BRight.getSelectedSensorPosition() > -125 && x == 2){
        ...
        if(BRight.getSelectedSensorPosition() < 125 && x == 4){
          mecanum.driveCartesian(0.5, 0, 0);
        }else if(x == 4){
          mecanum.driveCartesian(0, 0, 0);
          //shooter
